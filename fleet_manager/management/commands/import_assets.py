...
from fleet_manager.models import Asset, PurchaseDetails, FinancingDetails
...
class Command(BaseCommand):
    ...
    def convert_date_format(self, date_str, input_format='%Y/%m/%d', output_format='%Y-%m-%d'):
        ...
        try:
            ...
            print(
                f'Invalid date format for date: {date_str}. Expected format: yyyy/mm/dd')
            return None
        ...
        with open(csv_file_path, newline='', encoding='utf-8-sig') as csvfile:
            ...
            for row in reader:
                try:
                    ...
                    print(
                        f"Error processing row (invalid data type): {row}. Error: {e}")
